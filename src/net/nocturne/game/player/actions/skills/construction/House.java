...
import net.nocturne.game.npc.construction.Guard;
import net.nocturne.game.npc.construction.ServantNPC;
import net.nocturne.game.player.CompletionistCapeManager.Requirement;
import net.nocturne.game.player.FriendsIgnores;
import net.nocturne.game.player.Player;
import net.nocturne.game.player.Skills;
import net.nocturne.game.player.actions.skills.construction.HouseConstants.Builds;
import net.nocturne.game.player.actions.skills.construction.HouseConstants.HObject;
import net.nocturne.game.player.actions.skills.construction.HouseConstants.POHLocation;
import net.nocturne.game.player.actions.skills.construction.HouseConstants.Roof;
import net.nocturne.game.player.actions.skills.construction.HouseConstants.Room;
import net.nocturne.game.player.actions.skills.construction.HouseConstants.Servant;
