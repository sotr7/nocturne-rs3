...
public class SoulWarsController extends Controller {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.nocturne.game.player.Controllers.Controller#start()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.nocturne.game.player.Controllers.Controller#sendInterfaces()
	 */
	/**
	 * Send sw interfaces.
	 */
	 ...
	 * 
	 * @see
	 * net.nocturne.game.player.Controllers.Controller#processButtonClick(int,
	 * int, int, int)
	 */
	 ...
	 * 
	 * @see
	 * net.nocturne.game.player.Controllers.Controller#processObjectClick1(net
	 ...
	 * 
	 * @see
	 * net.nocturne.game.player.Controllers.Controller#canHit(net.nocturne.game
	 * .Entity )
	 */
	 ...
	 * 
	 * @see
	 * net.nocturne.game.player.Controllers.Controller#canAttack(net.nocturne
	 * .game .Entity)
	 */
