...
import net.nocturne.game.route.RouteStrategy;
import net.nocturne.game.route.strategy.EntityStrategy;
import net.nocturne.game.route.strategy.FixedTileStrategy;
import net.nocturne.game.route.strategy.FloorItemStrategy;
import net.nocturne.game.route.strategy.ObjectStrategy;
